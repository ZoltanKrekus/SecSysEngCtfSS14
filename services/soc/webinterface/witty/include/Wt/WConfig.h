...
#define WT_VERSION_STR "3.3.2"
#define WT_CLASS       "Wt3_3_2"
#define WT_INCLUDED_VERSION Wt_3_3_2

#define RUNDIR "/var/run/wt"
#define WT_CONFIG_XML "/etc/wt_config.xml"
#define WTHTTP_CONFIGURATION "/etc/wthttpd"
